...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('vendor/littlecloset/') ?>styles/checkout.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url('vendor/littlecloset/') ?>styles/checkout_responsive.css">
