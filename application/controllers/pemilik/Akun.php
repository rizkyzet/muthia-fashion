...
class Akun extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("tamplate_dashboard/sidebar_pemilik");
        $this->load->view("tamplate_dashboard/topbar");
        $this->load->view("pemilik/akun/form_akun");
    ...
    public function edit_akun()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view("tamplate_dashboard/sidebar_pemilik");
            $this->load->view("tamplate_dashboard/topbar");
            $this->load->view("pemilik/akun/form_editakun");
            $this->load->view("tamplate_dashboard/footer");
        } else {
    ...
    public function gantisandi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view("tamplate_dashboard/sidebar_pemilik");
            $this->load->view("tamplate_dashboard/topbar");
            $this->load->view("pemilik/akun/form_gantisandi");
            $this->load->view("tamplate_dashboard/footer");
        } else {
            ...
            if ($cek == false) {
                ...
                redirect("pemilik/akun/gantisandi");
            };
            $set = [
    ...
    public function ajax_provinsi()
    {
        ...
        $this->load->view('pemilik/akun/ajax_provinsi', $data);
    }
}
