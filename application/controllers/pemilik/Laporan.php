...
class Laporan extends CI_Controller
{
    ...
    public function penjualan()
    {
        ...
        $this->load->view("pemilik/laporan/form_penjualan");
    ...
    public function ajax_laporan_penjualan()
    {
        ...
        $this->load->view("pemilik/laporan/ajax_laporan_penjualan", $data);
    }
    ...
    public function cetak_laporan_penjualan()
    {
        ...
        $html = $this->load->view('pemilik/laporan/form_cetak_penjualan', $data, true);
    ...
    public function stok()
    {
        ...
        $this->load->view("tamplate_dashboard/sidebar_pemilik");
        $this->load->view("tamplate_dashboard/topbar");
        $this->load->view("pemilik/laporan/form_stok");
        $this->load->view("tamplate_dashboard/footer");
    }
